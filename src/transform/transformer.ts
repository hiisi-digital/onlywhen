...
function findOnlywhenImports(
  sourceFile: import("npm:typescript@5").SourceFile,
...
function evaluateCombinator(
  methodName: string,
  args: readonly import("npm:typescript@5").Expression[],
): boolean | undefined {
...
function evaluateFeature(
  arg: import("npm:typescript@5").Expression,
 ...
 */
function createBooleanLiteral(value: boolean): import("npm:typescript@5").Expression {
...
): import("npm:typescript@5").TransformerFactory<import("npm:typescript@5").SourceFile> {
  return (context) => {
    return (sourceFile) => {
       ...
       */
      function isOnlywhenIdentifier(node: import("npm:typescript@5").Node): boolean {
      ...
      function getOnlywhenObject(
        node: import("npm:typescript@5").PropertyAccessExpression,
      ): import("npm:typescript@5").Expression | undefined {
        const expr = node.expression;

        // Direct access: onlywhen.darwin
        if (
          isOnlywhenIdentifier(expr) &&
          !namespaceImports.has((expr as import("npm:typescript@5").Identifier).text)
        ) {
          return expr;
        }
       ...
       */
      function visitor(node: import("npm:typescript@5").Node): import("npm:typescript@5").Node {
            ...
            if (onlywhenObj) {
              ...
              if (COMBINATOR_METHODS.has(methodName)) {
                ...
                const transformedArgs = node.arguments.map((arg) =>
                  ts.visitNode(arg, visitor) as import("npm:typescript@5").Expression
                );
      ...
      return ts.visitNode(sourceFile, visitor) as import("npm:typescript@5").SourceFile;
    };
  };
}
